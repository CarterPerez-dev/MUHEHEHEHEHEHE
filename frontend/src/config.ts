...
export const API_ENDPOINTS = {
  ...
  EVALUATIONS: {
    BASE: `/${API_VERSION}/evaluations`,
    BY_ID: (id: string) => `/${API_VERSION}/evaluations/${id}`,
  },
} as const
...
export const QUERY_KEYS = {
  ...
  EVALUATIONS: {
    ...
    LIST: (page: number, size: number) =>
      [...QUERY_KEYS.EVALUATIONS.ALL, 'list', { page, size }] as const,
    BY_ID: (id: string) => [...QUERY_KEYS.EVALUATIONS.ALL, 'detail', id] as const,
  },
} as const
...
export const ROUTES = {
  ...
  EVALUATE: '/evaluate',
  HISTORY: '/history',
  RESULT: (id: string) => `/evaluations/${id}`,
  SETTINGS: '/settings',
