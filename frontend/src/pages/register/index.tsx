    ...
    <div className={styles.page}>
      <div className={styles.panel}>
        <header className={styles.head}>
          ...
          <span className={styles.tag}>{'AUTH // ENROLL'}</span>
        </header>

        <div className={styles.body}>
          <span className={styles.step}>01 / CREATE ACCESS</span>
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            >
              ...
              {!register.isPending && <LuArrowRight />}
            </button>
          </form>
        </div>

        <footer className={styles.foot}>
          <span className={styles.footMono}>HAVE ACCESS?</span>
