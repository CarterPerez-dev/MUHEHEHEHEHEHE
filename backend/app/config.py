...
class Settings(BaseSettings):
    ...
    APP_SUMMARY: str = "Resume evaluation, scored on demonstrated work"
    APP_DESCRIPTION: str = "MERIT - upload a resume, get a meritocratic engineering report card powered by Gemini with a local Ollama fallback"
